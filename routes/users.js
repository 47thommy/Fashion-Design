...
router.post("/signin", async (req, res) => {
  ...
  res
    .status(401)
    .render("home/signin", { message: "Invalid account or password" });
});
...
router.post("/account", async (req, res) => {
  ...
  try {
    ...
    if (username == oldUser.username)
      throw "You have to submit different username";
    if (password == oldUser.password)
      throw "You have to submit different password";
    if (password != Cpassword) throw "Password don't match";
    if (nickname == oldUser.nickname)
      throw "You have to submit different nickname";
    if (username) {
    ...
    let message3;
    let message4;
    if (e == "You have to submit different username")
      message1 = "You have to submit different username";
    if (e == "the username is already exisited")
      message1 = "the username is already exisited";
    if (e == "You have to submit different nickname")
      message2 = "You have to submit different nickname";
    if (e == "the nickname is already exisited")
      message2 = "the nickname is already exisited";
    if (e == "You have to submit different password")
      message3 = "You have to submit different password";
    if (e == "Password don't match") message3 = "Password don't match";
    if (e == "You have to submit different inputs before pushing button")
      message4 = "You have to submit different inputs before pushing button";
    ...
    res.status(404).render("users/useraccount", {
