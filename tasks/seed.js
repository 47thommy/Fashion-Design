...
async function main() {
  ...
  let u1 = await users.createUser(
    "un01@gmail.com",
    "$2a$10$S47.YnORnIZRLpMOSOINm.eUL4FoSLBFaWfk7qWT65.0c7unyjzGi",
    "Donglin"
  );
  ...
  let u2 = await users.createUser(
    "un02@gmail.com",
    "$2a$10$0A53QP0G0oeux7RFlNUqHuK7j5GU3zJjgYj3IQk02s4SznXUmcBLS",
    "Yaolin"
  );
  ...
  let u3 = await users.createUser(
    "un03@gmail.com",
    "$2a$10$2hDMVORERcJpQYDxhckLpeLtdOveKhEyFKeHFAfA4Qq6D62e4KfSe",
    "Jiayi"
  );
  ...
  let u4 = await users.createUser(
    "un04@gmail.com",
    "$2a$10$ad7Epy4AAPfrmRruDCwocu8Kq1lpRYTIj/fiQJ5qI/qGkvv0Ng3r6",
    "Zephyr"
  );
  let u4_userid = u4._id.toHexString();
  let u4_admin = await users.setAdminAccess(u4_userid); //set user4 as Admin
  let u5 = await users.createUser(
    "un05@gmail.com",
    "$2a$10$32lqGi/sY3G6IEnbDOwC5e1.6OLlu92Kkc/sYNR38240vfeJBwEkm",
    "nn05"
  );
  let u5_userid = u5._id.toHexString();
  let u6 = await users.createUser(
    "un06@gmail.com",
    "$2a$10$ZoH1i.W07uN/8OjP1vZGf.AAMFtp/eExMdzfzlrcb7VP9GX0MvfCm",
    "nn06"
  );
  let u6_userid = u6._id.toHexString();
  let u7 = await users.createUser(
    "un07@gmail.com",
    "$2a$10$vdXj7OW0b/rFJI3u1m/9QO1wVdVD5gWKaeBIk8t7hfVlTkokZlERy",
    "nn07"
  );
  let u7_userid = u7._id.toHexString();
  let u8 = await users.createUser(
    "un08@gmail.com",
    "$2a$10$9I1P3X89WLNzHRaTNRDJEuIPJl90TavRC8Gecy0p6bCf1WX7Nih66",
    "nn08"
  );
  ...
  //add comment to p1
  let c1 = await comments.addComment(
    p2_postid,
    u3_userid,
    "The subscription costs $99/month.You must be kidding. Could you make a discount?"
  );
  let c2 = await comments.addComment(
    p3_postid,
    u2_userid,
    "I think trump should raise his belt"
  );
